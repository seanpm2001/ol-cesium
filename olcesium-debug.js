...
class OLCesium {
  constructor(options) {
    ...
    if ((0,_util_js__WEBPACK_IMPORTED_MODULE_1__.supportsImageRenderingPixelated)()) {
      // non standard CSS4
      this.canvas_.style['imageRendering'] = (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.imageRenderingValue)();
    }
...
class RasterSynchronizer extends _AbstractSynchronizer__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  orderLayers() {
    ...
    (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.stableSort)(layers, (layer1, layer2) => zIndices[(0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getUid)(layer1)] - zIndices[(0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getUid)(layer2)]);
...
class VectorSynchronizer extends _AbstractSynchronizer__WEBPACK_IMPORTED_MODULE_6__["default"] {
  ...
  constructor(map, scene, opt_converter) {
    super(map, scene);
    this.converter = opt_converter || new _FeatureConverter_js__WEBPACK_IMPORTED_MODULE_7__["default"](scene);
  ...
  createSingleLayerCounterparts(olLayerWithParents) {
    ...
    [olLayerWithParents.layer].concat(olLayerWithParents.parents).forEach(olLayerItem => {
      olListenKeys.push((0,_util_js__WEBPACK_IMPORTED_MODULE_3__.olcsListen)(olLayerItem, 'change:visible', () => {
    ...
    const onAddFeature = function (feature) {
      ...
      if (prim) {
        featurePrimitiveMap[(0,_util_js__WEBPACK_IMPORTED_MODULE_3__.getUid)(feature)] = prim;
        csPrimitives.add(prim);
      }
    }.bind(this);
    const onRemoveFeature = function (feature) {
      const id = (0,_util_js__WEBPACK_IMPORTED_MODULE_3__.getUid)(feature);
      const context = counterpart.context;
    ...
    olListenKeys.push((0,_util_js__WEBPACK_IMPORTED_MODULE_3__.olcsListen)(source, 'addfeature', e => {
      console.assert(e.feature);
      onAddFeature(e.feature);
    }));
    olListenKeys.push((0,_util_js__WEBPACK_IMPORTED_MODULE_3__.olcsListen)(source, 'removefeature', e => {
      console.assert(e.feature);
      onRemoveFeature(e.feature);
    }));
    olListenKeys.push((0,_util_js__WEBPACK_IMPORTED_MODULE_3__.olcsListen)(source, 'changefeature', e => {
...
function sourceToImageryProvider(olMap, source, viewProj, olLayer) {
  ...
  if (source instanceof (ol_source_TileImage_js__WEBPACK_IMPORTED_MODULE_6___default())) {
    let projection = (0,_util_js__WEBPACK_IMPORTED_MODULE_11__.getSourceProjection)(source);
    if (!projection) {
...
/* harmony import */ var _core_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core.ts */ "./src/olcs/core.ts");
/**
 * @module olcs.Camera
 */
...
class Camera {
  ...
  setPosition(position) {
    ...
    console.assert(ll);
    const carto = new Cesium.Cartographic((0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toRadians)(ll[0]), (0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toRadians)(ll[1]), this.getAltitude());
    this.cam_.setView({
  ...
  getPosition() {
    ...
    const pos = this.fromLonLat_([(0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toDegrees)(carto.longitude), (0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toDegrees)(carto.latitude)]);
    console.assert(pos);
    return pos;
  }
  ...
  updateCamera_() {
    ...
    console.assert(ll);
    const carto = new Cesium.Cartographic((0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toRadians)(ll[0]), (0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toRadians)(ll[1]));
  ...
  readFromView() {
    ...
    this.distance_ = this.calcDistanceForResolution(resolution || 0, (0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toRadians)(ll[1]));
    this.updateCamera_();
  }
  ...
  updateView() {
    ...
    const ellipsoid = Cesium.Ellipsoid.WGS84;
    const scene = this.scene_;
    const target = (0,_core_ts__WEBPACK_IMPORTED_MODULE_3__.pickCenterPoint)(scene);
    ...
    this.view_.setCenter(this.fromLonLat_([(0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toDegrees)(bestTargetCartographic.longitude), (0,_math_js__WEBPACK_IMPORTED_MODULE_1__.toDegrees)(bestTargetCartographic.latitude)]));
  ...
  calcDistanceForResolution(resolution, latitude) {
    return (0,_core_ts__WEBPACK_IMPORTED_MODULE_3__.calcDistanceForResolution)(resolution, latitude, this.scene_, this.view_.getProjection());
  }
  ...
  calcResolutionForDistance(distance, latitude) {
    return (0,_core_ts__WEBPACK_IMPORTED_MODULE_3__.calcResolutionForDistance)(distance, latitude, this.scene_, this.view_.getProjection());
  }
}
...
/* harmony import */ var _core_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./core.ts */ "./src/olcs/core.ts");
/* harmony import */ var _core_VectorLayerCounterpart_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./core/VectorLayerCounterpart.ts */ "./src/olcs/core/VectorLayerCounterpart.ts");
...
class FeatureConverter {
  ...
  onRemoveOrClearFeature_(evt) {
    ...
    console.assert(source instanceof ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_2__);
    const cancellers = (0,_util_js__WEBPACK_IMPORTED_MODULE_9__.obj)(source)['olcs_cancellers'];
    if (cancellers) {
      ...
      if (feature) {
        ...
        (0,_util_js__WEBPACK_IMPORTED_MODULE_9__.obj)(source)['olcs_cancellers'] = {};
      }
    }
  }
  ...
  extractColorFromOlStyle(style, outline) {
    ...
    return (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.convertColorToCesium)(olColor);
  }
  ...
  olCircleGeometryToCesium(layer, feature, olGeometry, projection, olStyle) {
    olGeometry = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.olGeometryCloneTo4326)(olGeometry, projection);
    ...
    // Cesium
    center = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateToCesiumCartesian)(center);
    point = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateToCesiumCartesian)(point);
    ...
    if (this.getHeightReference(layer, feature, olGeometry) === Cesium.HeightReference.CLAMP_TO_GROUND) {
      ...
      if (width) {
        ...
        const positions = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateArrayToCsCartesians)(circlePolygon.getLinearRing(0).getCoordinates());
        if (!(0,_util_js__WEBPACK_IMPORTED_MODULE_9__.isGroundPolylinePrimitiveSupported)(this.scene)) {
          ...
          (0,_util_js__WEBPACK_IMPORTED_MODULE_9__.waitReady)(outlinePrimitive).then(() => {
  ...
  olLineStringGeometryToCesium(layer, feature, olGeometry, projection, olStyle) {
    ...
    const positions = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateArrayToCsCartesians)(olGeometry.getCoordinates());
    const width = this.extractLineWidthFromOlStyle(olStyle);
  ...
  olPolygonGeometryToCesium(layer, feature, olGeometry, projection, olStyle) {
    ...
    if (olGeometry.getCoordinates()[0].length == 5 && feature.get('olcs.polygon_kind') === 'rectangle') {
      ...
      for (let i = 0; i < rings.length; ++i) {
        ...
        const positions = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateArrayToCsCartesians)(olPos);
  ...
  createBillboardFromImage(layer, feature, olGeometry, projection, style, imageStyle, billboards, opt_newBillboardCallback) {
    if (imageStyle instanceof ol_style_Icon_js__WEBPACK_IMPORTED_MODULE_1__) {
    ...
    const reallyCreateBillboard = function () {
      ...
      const position = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateToCesiumCartesian)(center);
      let color;
    ...
    if (image instanceof Image && !isImageLoaded(image)) {
      ...
      let cancellers = (0,_util_js__WEBPACK_IMPORTED_MODULE_9__.obj)(source)['olcs_cancellers'];
      if (!cancellers) {
        cancellers = (0,_util_js__WEBPACK_IMPORTED_MODULE_9__.obj)(source)['olcs_cancellers'] = {};
      }
  ...
  olPointGeometryToCesium(layer, feature, olGeometry, projection, style, billboards, opt_newBillboardCallback) {
    ...
    if (imageStyle) {
      ...
      if (olcsModelFunction) {
        ...
        const options = /** @type {Cesium.ModelFromGltfOptions} */Object.assign({}, {
          scene: this.scene
  ...
  olGeometry4326TextPartToCesium(layer, feature, geometry, style) {
    ...
    if (geometry instanceof ol_geom_SimpleGeometry_js__WEBPACK_IMPORTED_MODULE_6__) {
      const first = geometry.getFirstCoordinate();
      extentCenter[2] = first.length == 3 ? first[2] : 0.0;
    }
    const options = /** @type {Cesium.optionsLabelCollection} */{};
    options.position = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.ol4326CoordinateToCesiumCartesian)(extentCenter);
    options.text = text;
  ...
  olStyleToCesium(feature, style, outline) {
    ...
    color = (0,_core_ts__WEBPACK_IMPORTED_MODULE_7__.convertColorToCesium)(color);
  ...
  getGeometryFromFeature(feature, style, opt_geom) {
    ...
    if (geom3d && geom3d instanceof ol_geom_Geometry_js__WEBPACK_IMPORTED_MODULE_0__) {
      return geom3d;
    }
    if (style) {
      const geomFuncRes = style.getGeometryFunction()(feature);
      if (geomFuncRes instanceof ol_geom_Geometry_js__WEBPACK_IMPORTED_MODULE_0__) {
        return geomFuncRes;
      }
    }
  ...
  olVectorLayerToCesium(olLayer, olView, featurePrimitiveMap) {
    ...
    let source = olLayer.getSource();
    if (source instanceof ol_source_Cluster_js__WEBPACK_IMPORTED_MODULE_3__) {
      source = source.getSource();
    }
    console.assert(source instanceof ol_source_Vector_js__WEBPACK_IMPORTED_MODULE_2__);
    const features = source.getFeatures();
    const counterpart = new _core_VectorLayerCounterpart_ts__WEBPACK_IMPORTED_MODULE_8__["default"](proj, this.scene);
    const context = counterpart.context;
...
const format = new ol_format_MVT_js__WEBPACK_IMPORTED_MODULE_0__();
const styles = [new ol_style_Style_js__WEBPACK_IMPORTED_MODULE_1__({
  stroke: new ol_style_Stroke_js__WEBPACK_IMPORTED_MODULE_2__({
    color: 'blue',
    width: 2
  })
})];
class MVTImageryProvider {
  constructor(options) {
    ...
    this.tileCache = new ol_structs_LRUCache_js__WEBPACK_IMPORTED_MODULE_6__(cacheSize);
    this.featureCache = options.featureCache || new ol_structs_LRUCache_js__WEBPACK_IMPORTED_MODULE_6__(cacheSize);
...
class SynchronizedOverlay extends ol_Overlay_js__WEBPACK_IMPORTED_MODULE_0__ {
  /**
...
/* harmony import */ var _OLCesium_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../OLCesium.ts */ "./src/olcs/OLCesium.ts");
/* harmony import */ var _core_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core.ts */ "./src/olcs/core.ts");
...
const Manager = class extends ol_Observable_js__WEBPACK_IMPORTED_MODULE_4__ {
  /**
   * @param {string} cesiumUrl
   * @param {olcsx.contrib.ManagerOptions} options
   * @api
   */
  constructor(cesiumUrl, _temp) {
    let {
      map,
  ...
  instantiateOLCesium() {
    ...
    const ol3d = new _OLCesium_ts__WEBPACK_IMPORTED_MODULE_1__["default"]({
      map: this.map
    });
  ...
  limitCameraToBoundingSphere() {
    const scene = this.ol3d.getCesiumScene();
    (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.limitCameraToBoundingSphere)(scene.camera, this.boundingSphere_, this.limitCameraToBoundingSphereRatio);
  }
  ...
  toggle3d() {
    return this.load().then(( /** @const {!olcs.OLCesium} */ol3d) => {
      ...
      if (is3DCurrentlyEnabled) {
        // Disable 3D
        console.assert(this.map);
        return (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.resetToNorthZenith)(this.map, scene).then(() => {
        ...
        this.dispatchEvent('toggle');
        return (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.rotateAroundBottomCenter)(scene, this.cesiumInitialTilt_);
      }
    });
  }
  ...
  getTiltOnGlobe() {
    const scene = this.ol3d.getCesiumScene();
    const tiltOnGlobe = (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.computeSignedTiltAngleOnGlobe)(scene);
    return -tiltOnGlobe;
  }
  ...
  setHeading(angle) {
    const scene = this.ol3d.getCesiumScene();
    const bottom = (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.pickBottomPoint)(scene);
    if (bottom) {
      (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.setHeadingUsingBottomCenter)(scene, angle, bottom);
    }
  }
...
class OLImageryProvider /* should not extend Cesium.ImageryProvider */ {
  ...
  handleSourceChanged_(frameState) {
    if (!this.ready_ && this.source_.getState() == 'ready') {
      this.projection_ = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getSourceProjection)(this.source_) || this.fallbackProj_;
      const options = {
  ...
  getTileCredits(x, y, level) {
    ...
    return (0,_core_ts__WEBPACK_IMPORTED_MODULE_2__.attributionsFunctionToCredits)(attributionsFunction, zoom, center, extent);
  }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _olcs_OLCesium_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./olcs/OLCesium.ts */ "./src/olcs/OLCesium.ts");
/* harmony import */ var _olcs_AbstractSynchronizer_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./olcs/AbstractSynchronizer.ts */ "./src/olcs/AbstractSynchronizer.ts");
/* harmony import */ var _olcs_RasterSynchronizer_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./olcs/RasterSynchronizer.ts */ "./src/olcs/RasterSynchronizer.ts");
/* harmony import */ var _olcs_VectorSynchronizer_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./olcs/VectorSynchronizer.ts */ "./src/olcs/VectorSynchronizer.ts");
/* harmony import */ var _olcs_core_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./olcs/core.ts */ "./src/olcs/core.ts");
...
/* harmony import */ var _olcs_core_VectorLayerCounterpart_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./olcs/core/VectorLayerCounterpart.ts */ "./src/olcs/core/VectorLayerCounterpart.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_olcs_OLCesium_ts__WEBPACK_IMPORTED_MODULE_0__["default"]);

const olcs = window['olcs'] = {};
olcs.OLCesium = _olcs_OLCesium_ts__WEBPACK_IMPORTED_MODULE_0__["default"];

olcs.AbstractSynchronizer = _olcs_AbstractSynchronizer_ts__WEBPACK_IMPORTED_MODULE_1__["default"];
olcs.RasterSynchronizer = _olcs_RasterSynchronizer_ts__WEBPACK_IMPORTED_MODULE_2__["default"];
olcs.VectorSynchronizer = _olcs_VectorSynchronizer_ts__WEBPACK_IMPORTED_MODULE_3__["default"];

olcs.core = _olcs_core_ts__WEBPACK_IMPORTED_MODULE_4__;
olcs.core.OLImageryProvider = _olcs_core_OLImageryProvider_js__WEBPACK_IMPORTED_MODULE_5__["default"];
olcs.core.VectorLayerCounterpart = _olcs_core_VectorLayerCounterpart_ts__WEBPACK_IMPORTED_MODULE_6__["default"];
